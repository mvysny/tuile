...
## State as of the last commit (`b70aadf`, branch `docs/design-docs-refresh`)

| file | bytes | note |
|---|---|---|
| `design/decisions.md` | 437 KB | was 565 KB; 73 entries, ~6 KB average |
| `design/research.md` | 42.5 KB | was 7 KB; 17 `R_` entries |
...
- **Some entries carried stale claims**, e.g. `D_integer_field` still said `content` / `content=`
  ...
  finds them — a doc that is confidently wrong is worse than one that is merely long.
