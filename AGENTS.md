...
- ✅ All 14 ported specs green (516 examples)
- ⏳ Rubocop: not yet cleaned (Phase 4)
- ⏳ YARD docs: gaps in `@param` / `@return` coverage (Phase 5)
- ⏳ RBS sigs: directory exists, only the bundler-stub `tuile.rbs`
  inside (Phase 6)
- ⏳ README quick-start, `examples/` (Phase 7)
